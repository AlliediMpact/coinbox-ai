...
- Name: User Onboarding Journey >> User can restart onboarding from profile settings
- Location: /workspaces/coinbox-ai/src/e2e-tests/onboarding.e2e.spec.ts:108:7
