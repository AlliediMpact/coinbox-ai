...
>(({ className, sideOffset = 4, children, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'bg-white rounded-md shadow-md p-1 w-56',
        'radix-side-top:animate-slide-down radix-side-bottom:animate-slide-up',
        className
      )}
      {...props}
    >
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      'px-2 py-1 text-xs font-semibold text-gray-500',
      className
    )}
    {...props}
  />
