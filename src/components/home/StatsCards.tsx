      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900 mb-4">
            The CoinBox <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">membership economy</span>
          </h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            See how members are trading, borrowing, and earning in real time.
          </p>
        </motion.div>
